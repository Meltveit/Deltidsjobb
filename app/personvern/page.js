        ...
        <div className="container-custom py-20">
            <div className="max-w-4xl mx-auto">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-gray-400">Vi tar ditt personvern på alvor.</p>
                </div>

                <div className="glass-card p-10 space-y-10 text-gray-300 leading-relaxed">
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">1. Behandlingsansvarlig</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">2. Hva vi samler inn</h2>
                        <div className="grid md:grid-cols-2 gap-6 mt-4">
                            <div className="bg-white/5 p-4 rounded-lg">
                                <h3 className="font-semibold text-white mb-2">For Bedrifter</h3>
                            ...
                            <div className="bg-white/5 p-4 rounded-lg">
                                <h3 className="font-semibold text-white mb-2">For Besøkende</h3>
                                <ul className="list-disc pl-5 text-sm space-y-1">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">3. Formålet med behandlingen</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">4. Utlevering til tredjepart</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">5. Dine rettigheter</h2>
                        <p>
                        ...
                        <p className="mt-4">
                            Ta kontakt med oss på <a href="mailto:personvern@deltidsjobb.no" className="text-primary-400 hover:underline">personvern@deltidsjobb.no</a> for å utøve dine rettigheter.
                        </p>
                    </section>
                </div>
            </div>
