        ...
        <>
            ...
            <div className="container-custom py-20">
                <div className="max-w-4xl mx-auto">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex flex-wrap gap-4 text-slate-600 mb-6">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>{job.companyName || 'Anonym arbeidsgiver'}</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex flex-wrap gap-2 mb-6">
                                    {(job.tags || []).map((tag) => (
                                        <span key={tag} className="tag bg-slate-100 text-slate-700 border-slate-200">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                                ...
                                <div className="text-sm text-slate-500">
                                    Publisert {formatDate(job.activatedAt || job.createdAt)} • {job.daysRemaining || 0} dager igjen
                                </div>
                            </div>

                            {/* Logo */}
                            {job.logo && (
                                <div className="w-32 h-32 flex-shrink-0 bg-white border border-slate-100 shadow-sm rounded-xl p-4 flex items-center justify-center">
                                    <img
                                        src={job.logo}
                                        alt={`${job.companyName || 'Bedrift'} logo`}
                    ...
                    {/* Job Description */}
                    <div className="glass-card mb-8">
                        <h2 className="text-2xl font-bold mb-4 text-slate-900 border-b border-slate-100 pb-2">Beskrivelse</h2>
                    ...
                    {/* Apply Section */}
                    <div className="glass-card text-center bg-slate-50/50 border-slate-200">
                        <h2 className="text-2xl font-bold mb-4 text-slate-900">Interessert?</h2>
