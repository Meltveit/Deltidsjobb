...
export async function createJob(jobData) {
    ...
    const job = {
        ...
        views: 0,
        // External job fields (default to null/fleksjobb)
        source: jobData.source || 'fleksjobb',
        externalId: jobData.externalId || null,
        originalLink: jobData.originalLink || null,
...
export async function getJobById(jobId) {
    ...
    return {
        ...
        source: job.source || 'fleksjobb',
        externalId: job.externalId || null,
        originalLink: job.originalLink || null,
